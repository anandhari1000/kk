...
no_tumor_images=os.listdir(image_dir+ '/lionel_messi')
yes_tumor_images=os.listdir(image_dir+ '/virat_kohli')
print("--------------------------------------\n")
...
make_prediction('Dataset_Celebrities/cropped/lionel_messi/lionel_messi2.png',model)
print("--------------------------------------\n")
make_prediction('Dataset_Celebrities/cropped/virat_kohli/virat_kohli2.png',model)
print("--------------------------------------\n")
